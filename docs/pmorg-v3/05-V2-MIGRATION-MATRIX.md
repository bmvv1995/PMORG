...
| Communication Gateway | adaptăm | prin Hermes/runner ajunge în același Turn Coordinator ca UI-ul |
...
- regula legacy „singura scriere este `message_post`”.
...
| channel gateway | se adaptează la `MessageEnvelope` și Turn API |
